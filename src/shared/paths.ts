...
export const PREVIEW_POINTS_PATH = "data/map-state.preview.json";
export const ROUTES_PATH = "data/routes.json";
export const PREVIEW_ROUTES_PATH = "data/routes.preview.json";
